...
const LatestJobCard = ({job}) => {
  ...
  return (
    <div onClick={()=> navigate(`/jobs/description/${job._id}`)} className='p-5 border border-gray-100 bg-white rounded-md shadow-xl cursor-pointer w-full max-w-full overflow-hidden'>
        <div>
